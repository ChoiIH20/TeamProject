...
<div class="modal-dialog" role="document">
	<div class="modal-content rounded-5 shadow">
		...
		<div class="modal-body p-5 pt-0">
			<form action="${pageContext.request.contextPath}/product/upload.do"
				...
				<div>
					...
					<input type="file" class="form-control rounded-4" name="image" id="image" accept=".jpg, .jpeg, .png, .JPG, .JPEG" /> 
